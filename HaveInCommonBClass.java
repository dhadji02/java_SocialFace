...
public class HaveInCommonBClass {
	...
	try {
		cstmt = conn.getDBConnection().prepareCall("{Call dhadji02.haveInCommonB (?)}", ResultSet.TYPE_SCROLL_INSENSITIVE,ResultSet.CONCUR_READ_ONLY);
		cstmt.setInt(1,id);	
